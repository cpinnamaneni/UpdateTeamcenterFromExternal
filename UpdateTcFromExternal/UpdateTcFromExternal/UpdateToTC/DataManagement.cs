...
public class DataManagement
{
     ...
     * Create ECN
     * 
     * @param propertyvalue id,Name,ExDate..
     */
     
     public void CreateECN()
        {
            // Reserve Item IDs and Create Items with those IDs
            ItemIdsAndInitialRevisionIds[] itemIds = generateItemIds(1, "A9_AutoCN");
            CreateItemsOutput[] newItems = createECNItems(itemIds, "A9_AutoCN");
        }
